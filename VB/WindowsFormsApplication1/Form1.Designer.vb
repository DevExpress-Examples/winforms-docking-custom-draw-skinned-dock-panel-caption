...
'#End Region
        Private myDockManager1 As WindowsFormsApplication1.MyDockManager

        Private myDockPanel2 As WindowsFormsApplication1.MyDockPanel

        Private myDockPanel2_Container As DevExpress.XtraBars.Docking.ControlContainer

        Private myDockPanel1 As WindowsFormsApplication1.MyDockPanel
        ...
        Private myDockPanel3 As WindowsFormsApplication1.MyDockPanel
